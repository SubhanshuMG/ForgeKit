...
features:
  ...
  - title: CI/CD from Day One
    details: GitHub Actions workflows are wired and green from your first commit. Push your code and the pipeline runs automatically.
  - title: Security by Default
    details: Path containment prevents directory traversal during scaffolding. Input validation runs on every CLI argument. Templates are scanned for secrets before merge.
  - title: Docker Ready
